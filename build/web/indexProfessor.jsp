<%-- 
    ...
    Created on : Sep 5, 2024, 1:48:13 AM
    Author     : User
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container my-5">
            <h1 class="text-center">Bem-vindo, ${sessionScope.pLogado.nomeProfessor}</h1>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <c:forEach var="denuncia" items="${DenunciaRepository.filterByProfessor(sessionScope.pLogado)}">
                        <tr>
